"""
Django settings for moviesstore project - Production version for PythonAnywhere
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-c1cpwn^jn(dc4yhl7f*0@vq-11g$b#9ppfj7syv8$4wd(c9u*9')
